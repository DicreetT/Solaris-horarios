...
const PROCESS_DEFINITIONS: Record<ProcessKey, ProcessDefinition> = {
  entradas_canet: {
    ...
    shortTitle: 'Entradas',
    responsible: 'Anabela / Fernando',
    review: 'Esteban',
    warehouse: 'Canet',
    accounting: 'Heidy',
    users: ['anabela', 'anabella', 'fernando', 'fer'],
    icon: Building2,
    color: {
  ...
  ventas_salidas: {
    ...
    shortTitle: 'Ventas',
    responsible: 'Itziar / Esteban / Anabela / Fernando',
    review: 'Anabela cuando aplique',
    accounting: 'Heidy',
    users: ['itzi', 'itziar', 'esteban', 'anabela', 'anabella', 'fernando', 'fer'],
    icon: ShoppingCart,
    color: {
